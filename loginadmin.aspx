...
<body>
    ...
    <div class="login-container">
        ...
        <h1 class="fw-bold text-white">Bienvenido a Administracion</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:baselConnectionString %>" SelectCommand="SELECT * FROM [admin] WHERE (([name] = @name) AND ([email] = @email) AND ([contra] = @contra))">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtName" Name="name" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txtEmail" Name="email" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txtPassword" Name="contra" PropertyName="Text" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</body>
</html>
